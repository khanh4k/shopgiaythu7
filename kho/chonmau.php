    ...
    <div class=" alert alert-primary">
        <h4 class="page-title">
            <span class="page-title-icon bg-gradient-primary text-white mr-2">
                ...
                class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $t ?>
        </h4>
    </div><br>
    <div class="card card-body">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="col-12">
                    <a class="nav-link"
                        href="?action=kho&view=apply&masp=<?php echo $masp ?>&t=<?php echo $t ?>&h=<?php echo $a ?>&mau=<?php echo $row['MaMau'] ?>">
                        <?php echo 'Màu  '.$row['MaMau']?></a>
                </div>
