        ...
        <div class=" alert alert-primary">
            <h4 class="page-title">
                <span class="page-title-icon bg-gradient-primary text-white mr-2">
                    ...
                    class="fas fa-chevron-right" style="font-size: 18px"></i>&#160;Xuất / Nhập Kho &#160;<i
                    class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $t ?> &#160;<i
                    class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $mau ?>
            </h4>
        </div><br>
        <div class="row">
            <div class="col-md-5">
                <table class="table table-active table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="form-check"><input class="form-check-input" value="<?php echo $row['MaSize'] ?>"
                                    type="checkbox" name="chon[]" id="<?php echo $row['MaSize'] ?>">
            ...
            <div class="col-md-7">
                <div class=" col-12 row">
                    <input onkeypress=" return isNumberKey(event)" class="form-control col-4 m-auto" type="text"
                        name="so" placeholder="nhập số lượng" required autofocus>
                    <input onkeypress=" return isNumberKey(event)" class="form-control col-4 m-auto" type="text"
                        name="dg" placeholder="nhập đơn giá" required>
                </div><br>
                ...
                <div class=" col-12 row">
                    ...
                    <button class=" m-auto col-4 btn btn-outline-primary" name="action" value="cong" type="submit">Nhập
                        Hàng</button>
                    <button class=" m-auto col-4 btn btn-outline-primary" name="action" value="tru" type="submit">Xuất
                        Hàng</button>
