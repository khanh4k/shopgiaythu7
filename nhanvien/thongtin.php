...
<div class="container-fluid">
    <div class=" alert alert-primary">
        <h4 class="page-title">
            ...
            </span> ADMIN &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Thông Tin Cá Nhân
        </h4>
    </div><br>
    <div class="card">
        <div class="card-body">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="pass" placeholder="Pass"
                                    value="<?php echo $r['MatKhau'] ?>">
                            </div>
                            <div class="form-group ">
                                <div class="col-md-12 ">
                                    <center>
                                        <input hidden name="manv" value="<?php echo $r['MaNV'] ?>">
                                        <button type="submit" name="luu" class="btn btn-md btn-dark pull-right"> Lưu
                                        </button>
                                    </center>
                                </div>
                            </div>
