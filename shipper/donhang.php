...
<div class="container-fluid">
    <div class=" alert alert-primary">
        <h4 class="page-title">
            ...
            </span> ADMIN &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Giao Hàng &#160;<i
                class="fas fa-chevron-right" style="font-size: 18px"></i>&#160;
        </h4>
    </div>
    <br>
    <div class="row">
        <form action="?action=giaohang" method="POST" class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body ">
                    <button type="sub" name="dk" value="Chưa Giao" class="btn btn-primary btn-sm"
                        style="font-family: Comfortaa;">Chờ xử lý</button>
                    <span class="counter counter-sm "><?php echo $dem ?></span>
                    <button type="sub" name="dk" value="Đã Giao" class="btn btn-primary btn-sm"
                        style="font-family: Comfortaa;">Đã Giao</button>
                </div>
            </div>
        </form>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">Đơn Hàng (ALL)</font>
                                </font>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <font style="vertical-align: inherit;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="text-info"
                                href="index.php?action=giaohang&view=ctgh&mahd=<?php echo $row['MaHD']; ?>">Detail </a>
                        </td>
                        <td><?php if($row['TinhTrang']==="Đã duyệt"){echo '<a class="text-info" href="shipper/xuly.php?action=duyet&mahd='.$row['MaHD'].'" >Đã Giao Hàng <i class="fas fa-check"></i> </a>';}?>
                        </td>
                    </tr>
                    <?php	} ?>
            ...
            <table class="table table-hover m-auto text-center" style="font-size: 13px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?action=giaohang&view=ctgh&mahd=<?php echo $row12['MaHD']; ?>">Detail </a>
                        </td>
                    </tr>
                    <?php	} ?>
                </tbody>
